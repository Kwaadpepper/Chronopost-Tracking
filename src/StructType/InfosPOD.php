...
class InfosPOD extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\Event|null
     */
    protected ?\StructType\Event $significantEvent = null;
    /**
     * The skybillNumber
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \StructType\Event $significantEvent
     ...
     */
    public function getSignificantEvent(): ?\StructType\Event
    {
     ...
     * @return \StructType\InfosPOD
     */
    public function setSignificantEvent(?\StructType\Event $significantEvent = null): self
    {
